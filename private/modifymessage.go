...
func (m *ModifyMessage) GetSender() string {
	return m.sender
}

func (m *ModifyMessage) SetReceiver(userId string) {
	m.receiver = userId
}

func (m *ModifyMessage) GetReceiver() string {
	return m.receiver
}

func (m *ModifyMessage) SetMsgKey(key string) {
	m.msgKey = key
}

func (m *ModifyMessage) GetMsgKey() string {
	return m.msgKey
}
